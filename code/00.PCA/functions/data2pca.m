...
function FinalData = data2pca (data, parameters)

Ntst = 1;

% My function
RowDataAdjust = data - repmat(parameters.data_mean, Ntst, 1);
FinalData = (parameters.U * RowDataAdjust')';

% % MATLAB function
% FinalData = (data - repmat(parameters.data_mean, Ntst, 1)) * U;